...
import { Heart, Share, Star, ArrowLeft, MapPin, Clock, User } from "lucide-react";
...
const ListingDetail = ({ listing }: ListingDetailProps) => {
  ...
  const listingData = listing || {
    ...
    location: "Al Shanab Gents Salon",
    distance: "14 B Street, Jumeirah 1, Dubai",
    dates: "6–11 Mar",
    price: "₹3,194",
    rating: 5.0,
    isNew: false,
    isFavorite: false,
    description: "Experience luxury in the heart of Dubai. This stunning salon space offers a perfect blend of traditional and modern aesthetics.",
    host: {
      name: "Rajesh",
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header - consistent with home page design */}
      ...
      <div className="pt-[80px]">
        ...
        <div className="px-6 py-4 border-b">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>Dubai</span>
            <span>•</span>
            <span>Jumeirah 1</span>
            <span>•</span>
            <span className="text-black font-medium">Al Shanab Gents Salon</span>
          </div>
        </div>

        {/* Salon Header */}
        <div className="px-6 py-6">
          <h1 className="text-3xl font-bold mb-4">Al Shanab Gents Salon</h1>
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="flex items-center gap-1">
              ...
              <span className="text-purple-600 underline">(591)</span>
            </div>
            <span>•</span>
            <span className="text-orange-600 font-medium">Closed</span>
            <span>- opens soon at 3:00 pm</span>
            <span>•</span>
            <span>14 B Street, Jumeirah 1, Dubai</span>
            <button className="text-purple-600 underline">Get directions</button>
          </div>
        ...
        <div className="px-6 py-8">
          <div className="flex gap-4 mb-6">
            <Button className="rounded-full px-6 py-2 bg-black text-white hover:bg-black/90">
              Featured
            </Button>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-6 rounded-2xl border hover:shadow-md transition-shadow">
              <div>
                <h3 className="text-xl font-semibold mb-1">Threading/Trimming/Shaving</h3>
                <p className="text-gray-500">45 mins</p>
                <p className="text-xl font-semibold mt-2">AED 40</p>
              </div>
              <Button className="rounded-full px-8 bg-green-600 hover:bg-green-700">Book</Button>
            </div>
            ...
            <div className="flex items-center justify-between p-6 rounded-2xl border hover:shadow-md transition-shadow">
              <div>
                <h3 className="text-xl font-semibold mb-1">Manicure & Pedicure</h3>
                <p className="text-gray-500">45 mins</p>
            ...
            <div className="flex items-center justify-between p-6 rounded-2xl border hover:shadow-md transition-shadow">
              <div>
                <h3 className="text-xl font-semibold mb-1">Complete Head Shave</h3>
          ...
          <Button variant="outline" className="mt-8 text-lg font-medium rounded-full px-8 py-6">
            See all
          </Button>
        </div>
          ...
          <div className="grid grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="relative mb-4">
                ...
                />
                <div className="absolute bottom-0 right-0 bg-white rounded-full px-2 py-1 shadow-md">
                  <div className="flex items-center gap-1">
              ...
              <h3 className="text-lg font-semibold mb-1">Elbie</h3>
              <p className="text-gray-500">Therapist</p>
            </div>

            <div className="text-center">
              <div className="relative mb-4 bg-purple-100 rounded-full aspect-square flex items-center justify-center">
                <span className="text-4xl text-purple-600">L</span>
                <div className="absolute bottom-0 right-0 bg-white rounded-full px-2 py-1 shadow-md">
                  <div className="flex items-center gap-1">
                    <span className="font-semibold text-sm">5.0</span>
                    <Star className="h-3 w-3 fill-current" />
              ...
              <h3 className="text-lg font-semibold mb-1">Liezel and Elbie</h3>
              <p className="text-gray-500">Head Therapist</p>
            </div>

            <div className="text-center">
              <div className="relative mb-4 bg-purple-100 rounded-full aspect-square flex items-center justify-center">
                <span className="text-4xl text-purple-600">A</span>
                <div className="absolute bottom-0 right-0 bg-white rounded-full px-2 py-1 shadow-md">
                  <div className="flex items-center gap-1">
              ...
              <h3 className="text-lg font-semibold mb-1">Ahmed</h3>
              <p className="text-gray-500">Beard Specialist</p>
            </div>

            <div className="text-center">
              <div className="relative mb-4 bg-purple-100 rounded-full aspect-square flex items-center justify-center">
                <span className="text-4xl text-purple-600">R</span>
                <div className="absolute bottom-0 right-0 bg-white rounded-full px-2 py-1 shadow-md">
                  <div className="flex items-center gap-1">
                    <span className="font-semibold text-sm">5.0</span>
                    <Star className="h-3 w-3 fill-current" />
              ...
              <h3 className="text-lg font-semibold mb-1">Romeo</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-1">Ayaz</h3>
              <p className="text-gray-500">Beard Specialist</p>
            </div>

            <div className="text-center">
              <div className="relative mb-4 bg-purple-100 rounded-full aspect-square flex items-center justify-center">
                <span className="text-4xl text-purple-600">M</span>
                <div className="absolute bottom-0 right-0 bg-white rounded-full px-2 py-1 shadow-md">
                  <div className="flex items-center gap-1">
                    <span className="font-semibold text-sm">5.0</span>
                    <Star className="h-3 w-3 fill-current" />
              ...
              <h3 className="text-lg font-semibold mb-1">Muhammad</h3>
              <p className="text-gray-500">Beard Specialist</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-1">Reynil</h3>
        ...
        <div className="px-6 py-8">
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div>
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-purple-100 rounded-full h-12 w-12 flex items-center justify-center">
                  <span className="text-xl text-purple-600">S</span>
                </div>
                <div>
                  <h3 className="font-semibold text-lg">Surendra singh T.</h3>
                  <p className="text-gray-500">Fri, 14 Feb, 2025 at 10:16 pm</p>
                </div>
              </div>
              ...
              <p>Liked the place . And hair stylist. He gave a nice hair cut.</p>
            </div>

            <div>
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-purple-100 rounded-full h-12 w-12 flex items-center justify-center">
                  <span className="text-xl text-purple-600">O</span>
                </div>
                <div>
                  <h3 className="font-semibold text-lg">Odd arvid W.</h3>
                  <p className="text-gray-500">Thu, 30 Jan, 2025 at 10:59 pm</p>
                </div>
              </div>
              <div className="flex mb-2">
                {[1, 2, 3, 4, 5].map((star) => (
            ...
            <div>
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-purple-100 rounded-full h-12 w-12 flex items-center justify-center">
                  <span className="text-xl text-purple-600">Y</span>
                </div>
                <div>
                  <h3 className="font-semibold text-lg">Yahya</h3>
                  <p className="text-gray-500">Thu, 30 Jan, 2025 at 7:05 pm</p>
                </div>
              </div>
              <div className="flex mb-2">
                {[1, 2, 3, 4, 5].map((star) => (
            ...
            <div>
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500">Tue, 14 Jan, 2025 at 9:38 pm</p>
                </div>
              </div>
              <div className="flex mb-2">
                {[1, 2, 3, 4, 5].map((star) => (
            ...
            <div>
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-purple-100 rounded-full h-12 w-12 flex items-center justify-center">
                  <span className="text-xl text-purple-600">R</span>
                </div>
                <div>
            ...
            <div>
              ...
              <p>Best Hair Salon in Dubai!<br />The whole team is amazing at what they do.</p>
            </div>
          </div>
        ...
        <div className="px-6 py-8 bg-gray-50">
          ...
          {/* Map Section */}
          <div className="mb-8 rounded-2xl overflow-hidden h-[300px] bg-gray-200">
            <img
              src="https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/55.2667,25.2048,12,0/800x300@2x?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw"
        ...
        <div className="px-6 py-8">
          <h2 className="text-3xl font-bold mb-8">Nearby venues</h2>
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-xl">Jumeirah Beach Salon</h3>
